# \# AGENTS.md — StoryForge Build Context
...
* Auth + DB: Supabase
* AI: Anthropic API (Codex-haiku-4-5) — server-side only
...
3. Readiness Score — 0-100
   ...
   * 0-49: Tidak Siap
4. PRD Draft — structured, ready to paste to Codex/Cursor
...
2. Fix /api/analyze — currently Gemini, must use Anthropic Codex-haiku-4-5
...
\- Codex writes `.md` files → Obsidian auto-detects
